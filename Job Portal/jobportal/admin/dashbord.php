      ...
      <div class="row row-cols-1 row-cols-md-3 g-4 px-4 py-4">
        ...
        <div class="card text-dark text-center bg-warning mb-4" style="max-width: 18rem; padding: 20px; margin: 20px;">
          ...
          <div class="card-body">
            <h5 class="card-title">10</h5>
            <p class="card-text">View</p>
            <!-- <a href="company.php" style="font-weight:200;text-decoration:none;text-align:center;color: #fff;"><b> View</a> -->
          </div>
        </div>
        <div class="card text-dark text-center bg-info mb-4" style="max-width: 18rem; padding: 20px; margin: 20px;">
          ...
          <div class="card-body">
            ...
            <!-- <p class="card-text">View</p> -->
            <a href="users.php" style="font-weight:200;text-decoration:none;text-align:center;color: #fff;"><b> View</a>
          </div>
        </div>
        <div class="card text-white text-center bg-success mb-4" style="max-width: 18rem; padding: 20px; margin: 20px;">
          ...
          <div class="card-body">
            ...
            <!-- <p class="card-text">View</p> -->
            <a href="company-registration.php" style="font-weight:200;text-decoration:none;text-align:center;color: #fff;"><b> View</a>
          </div>
        </div>
      </div>
      </div>
